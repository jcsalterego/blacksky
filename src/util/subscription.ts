...
export abstract class FirehoseSubscriptionBase {
  ...
  async run() {
    ...
    const hardcoded_removes = ['did:plc:buofnbcavecxm3kr6x5npusi','did:plc:le6rojzdlcqqbun4mwlo64wr','did:plc:y742yf6jzv7rznyxsyn3nyo6','did:plc:yz4djetpmxqhpkzabiaose6k','did:plc:5cn7tila5pqvqk7jbkgfz6hd','did:plc:vt2iihswfztajz4xme6w4hiy','did:plc:k5f642ejcpths5dehw7shm5t']
